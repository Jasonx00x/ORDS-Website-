...
function layout({ slug, title, desc, body, image = socialImage, ogImage, ogImageAlt, ogTitle, ogDesc, ogUrl, canonicalUrl }) {
  ...
  const shareImage = ogImage || socialImage || image;
  const shareImageDimensions = ogImage ? '  <meta property="og:image:width" content="1200">\n  <meta property="og:image:height" content="630">\n' : "";
  return `<!doctype html>
<html lang="en">
<head>
  <meta charset="utf-8">
...
${shareImageDimensions}  <meta property="og:image:alt" content="${escapeHtml(ogImageAlt || siteName)}">
...
function indexPage() {
  ...
  <section class="light home-classes"><div class="container"><div class="section-head reveal"><span class="eyebrow tag-on-light">Music Lessons We Offer</span><h2>Choose your instrument.</h2><p>From first notes to advanced growth, we help students build skill, confidence, and discipline.</p></div><div class="cards six">${cards}</div></div></section>
...
function consultationPage() {
  ...
  <section class="consult-flow calendly-section"><div class="container"><div class="section-head reveal"><span class="eyebrow tag-on-light">Consultation</span><h2>Schedule your 30-minute consultation.</h2><p>Choose an available time for your free ORDS consultation.</p></div><div class="calendly-shell reveal"><div class="calendly-inline-widget" data-url="https://calendly.com/alfaroje26/30min?hide_event_type_details=1&primary_color=000000" style="min-width:320px;height:700px;"></div></div></div></section><script type="text/javascript" src="https://assets.calendly.com/assets/external/widget.js" async></script>`;
...
function hiringPage() {
  ...
  const hiringSocialImage = "https://res.cloudinary.com/dtmonxj1h/image/upload/c_fill,g_auto,w_1200,h_630,f_auto,q_auto:good/v1785785432/7IV00377_1_djjxi5.jpg";
  ...
  return layout({ slug: "hiring", title, desc, body, image: drumStudentImg, ogImage: hiringSocialImage, ogImageAlt: "ORDS musician performing behind a drum kit" });
}
